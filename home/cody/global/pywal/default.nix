{
  ...
  xdg.configFile."wal/templates/colors-tmux.conf".text = ''
    set-option -g status-style fg="{foreground}",bg="{color8}"
  ...
  '';
  xdg.configFile."wal/templates/colors-zsh.zsh".text = ''
    ...
    color15="{color15}"
  '';
  xdg.configFile."wal/templates/hyprland-colors.conf".text = ''
  ...
  '';
  xdg.configFile."wal/templates/nix-snowflake.svg".text = ''
    ...
    <svg
      ...
      <defs
        ...
        <linearGradient
          ...
          <stop
             style="stop-color:{color12};stop-opacity:1"
             offset="0"
             id="stop5564" />
          <stop
             id="stop5566"
        ...
        <linearGradient
          ...
          <stop
             style="stop-color:{color6};stop-opacity:1"
             offset="0"
             id="stop5055" />
          <stop
             id="stop5057"
