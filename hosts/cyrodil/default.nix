{
  ...
  boot = {
    ...
    kernelParams = [
      ...
      "amd_iommu=on" # Enables AMD IOMMU (AMD-Vi)
      "iommu=pt" # Passthrough mode — recommended for performance (IOMMU only active for passed-through devices)
    ];
    initrd = {
      # ISSUE: https://github.com/nix-community/impermanence/issues/320
      #
